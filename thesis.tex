...
The proposed system is built with:
\begin{itemize}
  \item Media converter + SFP 1490/1550 rx/tx BIDI DDM, 1 optical channel
  \item 3d mechanical movement allowing for SFP translation
  \item Electical control system controling the mechanics and tapping into SFP's DDM
  \item Low throughput RF transmission
  \item Plano convex 50mm 85mm fl 
\end{itemize}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{figures/System_diagram.jpg}
    \caption[short]{System diagram}
    \label{fig1:diag}
\end{figure}
